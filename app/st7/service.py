...
# ⚠️ ВАЛЮТНЫЕ перпы (04.07): claim «USDRUBF +48%/год, EURRUBF +38%» ОПРОВЕРГНУТ честной
# переоценкой 07.07 — реальный фандинг-компонент ~11.6%/USDRUBF и ~8.6%/EURRUBF, и обе
# пары УБЫТОЧНЫ после carry+комиссий даже в удачный год (USDRUBF −4%/год, EURRUBF −10.8%).
# «245 дней >35пп» считалось на маленькую базу, не на удержанный нотионал. usdrubf/eurrubf
# — кандидаты на удаление (держат хвостовой риск девальвации без edge). st7 ОСТАНОВЛЕНА,
# на бой не выводить — см. docstring config.py.
